...
public class HttpClientEx {
    public static void main(String[] args) throws ExecutionException, InterruptedException, NoSuchAlgorithmException {
        ...
        HttpResponse<String> httpResponseCompletableFuture = HttpClient.newHttpClient()
                .sendAsync(httpRequest, HttpResponse.BodyHandlers.ofString()).get();

        String body =  httpResponseCompletableFuture.body();
